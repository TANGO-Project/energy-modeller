...
public class WattsUpMeterDataSourceAdaptor implements HostDataSource {
    ...
    private WattsUpMeterDataSourceAdaptor() {
        String port = settings.getString("energy.modeller.wattsup.port", "COM9");
        int hostId = settings.getInt("energy.modeller.wattsup.hostId", 1);
        String hostname = settings.getString("energy.modeller.wattsup.hostname", "localhost");
